...
Title.Text = "✨ Selamat datang di Panel Summit!"
...
-- FPS Counter
local FPSLabel = Instance.new("TextLabel", HomePage)
FPSLabel.Size = UDim2.new(0.9,0,0,25)
FPSLabel.Position = UDim2.new(0.05,0,0.20,0)
FPSLabel.Text = "FPS: 0"
...
-- Username
local NameLabel = Instance.new("TextLabel", HomePage)
NameLabel.Size = UDim2.new(0.9,0,0,25)
NameLabel.Position = UDim2.new(0.05,0,0.28,0)
NameLabel.Text = "👤 User: "..game.Players.LocalPlayer.Name
...
local DeviceLabel = Instance.new("TextLabel", HomePage)
DeviceLabel.Size = UDim2.new(0.9,0,0,25)
DeviceLabel.Position = UDim2.new(0.05,0,0.36,0)
...
-- IG Developer (Rainbow Text)
local IGLabel = Instance.new("TextLabel", HomePage)
IGLabel.Size = UDim2.new(0.9,0,0,25)
IGLabel.Position = UDim2.new(0.05,0,0.45,0)
IGLabel.Text = "📌 Follow IG: @frkhnsptra__"
IGLabel.Font = Enum.Font.GothamBold
IGLabel.TextSize = 15
IGLabel.BackgroundTransparency = 1
IGLabel.TextXAlignment = Enum.TextXAlignment.Left

-- Animasi Rainbow untuk IG
task.spawn(function()
    local hue = 0
    while task.wait(0.05) do
        hue = (hue + 0.01) % 1
        IGLabel.TextColor3 = Color3.fromHSV(hue,1,1)
    end
end)
