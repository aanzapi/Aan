...
Card.Size = UDim2.new(0.9,0,0,180)
...
DeviceLabel.Position = UDim2.new(0,10,0,70)
DeviceLabel.Text = "📱 Device: "..tostring(UIS:GetPlatform())
...
IGLabel.Position = UDim2.new(0,10,0,130)
