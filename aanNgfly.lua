...
-- Shadow
local Shadow = Instance.new("UIStroke", Card)
Shadow.Thickness = 2
Shadow.Color = Color3.fromRGB(80,80,120)
...
UserLabel.Text = "👤 Username: "..game.Players.LocalPlayer.Name
...
FPSLabel.Position = UDim2.new(0,10,0,95)
FPSLabel.Text = "⏱️ FPS: ..."
...
IGLabel.Size = UDim2.new(1,-20,0,25)
IGLabel.Position = UDim2.new(0,10,0,125)
