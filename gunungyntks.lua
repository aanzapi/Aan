...
---------------- PAGE 3 (Auto Summit Mount YNTKTS) ----------------
-- BUTTON AUTO SUMMIT
...
local summitPoints = {
    ...
    CFrame.new(1015.154602, 71.136703, -107.262527, 0.799797, 0, 0.600271, 0, 1, 0, -0.600271, 0, 0.799797),
    CFrame.new(2085.536133, 71.592369, -146.944305, 0.868378, 0, 0.495903, 0, 1, 0, -0.495903, 0, 0.868378),
    CFrame.new(2327.832031, 62.742851, -141.300720, 0.106363, 0, -0.994327, 0, 1, 0, 0.994327, 0, 0.106363),
    CFrame.new(2550.327881, 42.393738, -411.493347, 0.734386, 0, 0.678732, 0, 1, 0, -0.678732, 0, 0.734386),
    CFrame.new(2680.547363, 86.599533, -333.145721, 0.152885, 0, -0.988244, 0, 1, 0, 0.988244, 0, 0.152885),
    CFrame.new(2715.542969, 158.720352, -358.347076, 0.995701, 0, 0.092621, 0, 1, 0, -0.092621, 0, 0.995701),
    CFrame.new(3040.033936, 154.523895, -364.891449, -0.085736, 0, 0.996318, 0, 1, 0, -0.996318, 0, -0.085736),
    CFrame.new(3228.980469, -5.329407, -337.695892, 1, 0, 0, 0, 1, 0, 0, 0, 1),
    CFrame.new(3670.524414, 22.656361, -222.587601, -0.999522, 0, 0.030925, 0, 1, 0, -0.030925, 0, -0.999522),
    CFrame.new(3725.065674, 90.512352, -247.276718, 0.411926, 0, -0.911217, 0, 1, 0, 0.911217, 0, 0.411926),
    CFrame.new(3966.540771, 66.735832, -308.063110, -0.243401, 0.000000, -0.969926, 0.000000, 1.000000, 0.000000, 0.969926, -0.000000, -0.243401),
    CFrame.new(4438.899414, 83.455597, -309.439423, -0.072967, 0, -0.997334, 0, 1, 0, 0.997334, 0, -0.072967),
    CFrame.new(4520.607422, 81.003944, -281.054810, 0.119383, 0, -0.992848, 0, 1, 0, 0.992848, 0, 0.119383),
}
...
SummitBtn.MouseButton1Click:Connect(function()
    ...
    SummitBtn.Text = autoSummit and "⛰️ Auto Summit: ON" or "⛰️ Auto Summit: OFF"
        ...
        task.spawn(function()
            while autoSummit do
                for _,pos in ipairs(summitPoints) do
                    ...
                    task.wait(2) -- ⏳ jeda 2 detik antar teleport
                end
            end
        end)
    end
...
StecuBtn.Position = UDim2.new(0.05,0,0.12,0) -- geser dikit biar di bawah tombol YNTKTS
...
-- LIST CFRAME SUMMIT STECU (ambil dari checkpoint FF Main yg kamu kasih tadi, urutin bawah ke atas)
local stecuPoints = {
...
-- VARIABEL AUTO SUMMIT STECU
local autoStecu = false

-- LOGIC AUTO SUMMIT STECU
