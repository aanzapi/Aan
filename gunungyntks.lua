...
----------------------------------------------------------------
-- 📍 LIST CFRAME SUMMIT STECU (diisi dari FF Main checkpoint)
----------------------------------------------------------------
local stecuPoints = {
...
local function createSummitFrame(title,posY,points)
    ...
    ManualFrame.Size = UDim2.new(0.9,0,0,35)
    ManualFrame.Position = UDim2.new(0.05,0,0.8,0)
    ManualFrame.BackgroundTransparency = 1

    local UIList = Instance.new("UIListLayout", ManualFrame)
